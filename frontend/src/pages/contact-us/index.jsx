...
const Index = () => {
    return (
        <section className="bg-white dark:bg-gray-900 md:h-[75vh]">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="mb-4 mt-[50px] text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact
                    Us</h2>
