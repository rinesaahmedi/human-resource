            ...
            <div className={"flex max-w-[1600px] w-[100%] items-center justify-center justify-between"}>
                <div className="flex flex-col max-w-[630px] text-center lg:text-left">
                    ...
                    <div className="flex justify-center lg:justify-start gap-4">
                        <button
                            className="bg-white text-[#599698] font-semibold py-2 px-6 rounded hover:bg-[#88C0C3] hover:text-white transition-all">
                            Get Started Today
                        </button>
                        <button
                            className="bg-transparent border border-white py-2 px-6 rounded text-white hover:bg-white hover:text-[#599698] transition-all">
                            Try Demo Account
                        </button>
                    </div>
                </div>
