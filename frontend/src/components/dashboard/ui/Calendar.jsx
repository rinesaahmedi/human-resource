...
import DayPicker from "react-daypicker/lib/DayPicker";
function Calendar({
                      className,
                      classNames: customClassNames, // Renamed to avoid conflict with the classNames import
    ...
    return (
        <DayPicker
            ...
            className={classNames("p-3 text-gray-600 dark:text-gray-100", className)}
            classNames={{
